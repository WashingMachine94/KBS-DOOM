...
HD_PWD='C:/Users/lucas/Documents/GitHub/KBS-DOOM/KBS-DOOM/KBS-DOOM.runs/system_vga_display_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_vga_display_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_vga_display_0_0.tcl
